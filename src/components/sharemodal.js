            ...
            aria-labelledby="contained-modal-title-vcenter">
                    ...
                    <Modal.Body className="bg-white px-3 py-2">
                        ...
                        <div className="row col-12">
                            <div className="col-3">
                            <a  className="resp-sharing-button__link" href={ `https://api.whatsapp.com/send?text=I%20placed%20this%20bet%20on%20surebet.co.ke%20Cheki%20mkeka%20wangu%20na%20ubeti.%20https://surebet.co.ke/betslip/share/${shareId}` } target="_blank" title="Share via Whatsapp">
