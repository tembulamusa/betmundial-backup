...
const ShareModal = (props) => {
    ...
    const createSharableBet = useCallback(async () => {
        ...
        let sharedSlip = Object.values(betslip || []);
        let payload = {
            bet_string: 'web',
            app_name: 'desktop',
                    ...
                    <Modal.Body className="bg-white px-3 py-2">
                        { doneShare === false ? (
                            ...
                            <div className="row col-12">
                                <div className="col-3">
                                <a rel="noreferrer" className="resp-sharing-button__link" href={ `https://api.whatsapp.com/send?text=I%20placed%20this%20bet%20on%20surebet.co.ke%20Check%20my%20bet%20and%20bet.%20https://surebet.co.ke/betslip/share/${shareId}` } target="_blank" title="Share via Whatsapp">
