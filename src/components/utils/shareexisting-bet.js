                    ...
                    <Modal.Body className="bg-white px-3 py-2">
                        { doneShare == false ? (
                            ...
                            <div className="row col-12">
                                <div className="col-3">
                                <a rel="noreferrer" className="resp-sharing-button__link" href={ `https://api.whatsapp.com/send?text=I%20placed%20this%20bet%20on%20betmundial.co.ke%20Check%20my%20bet%20and%20bet.%20https://betmundial.co.ke/betslip/share/${shareId}` } target="_blank" title="Share via Whatsapp">
                                ...
                                <div className="col-3">
                                <a className="resp-sharing-button__link" href={ `https://facebook.com/sharer/sharer.php?u=https://betmundial.co.ke/betslip/share/${shareId}`} target="_blank" rel="noopener" aria-label="Share on Facebook">
                                ...
                                <div className="col-3">
                                <a className="resp-sharing-button__link" href={ `https://twitter.com/intent/tweet/?text=I%20placed%20this%20bet%20on%20https://betmundial.co.ke%20Cheki%20mkeka%20wangu%20na%20ubeti&amp;url=https://betmundial.co.ke/betslip/share/${shareId}` } target="_blank" rel="noopener" aria-label="Share on Twitter">
                            ...
                            <ClipboardCopy copyText={`https://betmundial.co.ke/betslip/share/${shareId}` } />
